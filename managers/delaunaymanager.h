...
#include <drawable/drawablevoronoi.h>
namespace Ui {
...
private:
    ...
    DelaunayT triangulation;

    //Drawable di delaunay e voronoi
    DrawableDelaunayTriangulation delaunay;
    DrawableVoronoi voronoi;

    //mappa di associazione dei punti con il loro relativo indice nel vettore
    std::map<cg3::Point2Dd, unsigned int> indexPoint;
    /********************************************************************************************************************/
